...
const Checkout = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(API_BASE_URL + "api/checkout_react.php", {
        method: "POST",
      ...
      if (data.status === "success") {
        if (paymentMethod === "ONLINE") {
          const options = {
            key: "rzp_test_SwHDwTn8mGkDmv",
            amount: finalTotal * 100,
            currency: "INR",
            name: "Pure Plant",
            description: "Premium Marketplace Checkout",
  ...
  const handleApplyCoupon = async () => {
    ...
    try {
      const res = await fetch(API_BASE_URL + "api/apply_coupon.php", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          code: couponCode,
        ...
        <div className="w-full max-w-2xl bg-white rounded-[2.5rem] p-8 md:p-12 shadow-xl shadow-stone-100 border border-stone-100 text-center space-y-8">
          ...
          <div className="space-y-3">
            ...
            <p className="text-stone-400 text-sm font-medium leading-relaxed font-sans max-w-md mx-auto">
              Thank you for shopping with us. Your items are being prepared for
              dispatch!
            </p>
          </div>
          ...
          <div className="bg-stone-50 rounded-3xl p-6 text-left border border-stone-100 space-y-4 font-sans text-xs">
            ...
            <div className="grid grid-cols-2 gap-4 pt-1">
              <div>
                ...
                <span className="font-bold text-[#1e2925]">
              ...
              <div>
                ...
                <span className="font-bold text-[#1e2925] truncate block">
                  {formData.email}
                </span>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4 border-t border-stone-200/40 pt-3">
              <div>
                ...
                <span className="font-black text-emerald-600 bg-emerald-50 border border-emerald-100 px-2 py-0.5 rounded-lg text-[10px] inline-block uppercase tracking-wider">
            ...
            <div className="border-t border-stone-200/60 pt-4 flex justify-between items-end">
              ...
              <span className="text-2xl font-black text-[#1e2925] leading-none">
  ...
  return (
    <div className="min-h-screen bg-gray-50 pt-10 pb-16">
      <div className="container mx-auto px-6 max-w-6xl">
        <h1 className="text-4xl font-black uppercase tracking-tighter text-black mb-12">
          Checkout
        </h1>
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <div className="w-full lg:w-[65%]">
            <div className="bg-white p-8 rounded-3xl border border-gray-100 shadow-sm">
              <h2 className="text-xl font-black uppercase tracking-widest text-gray-800 mb-8">
                Shipping Details
              </h2>
          ...
          <div className="w-full lg:w-[35%]">
            <div className="bg-white p-8 rounded-3xl border border-gray-100 shadow-sm sticky top-32">
              <h2 className="text-xl font-black uppercase tracking-widest text-gray-800 mb-6">
                Your Order
              </h2>
                        ...
                        src={
                          item.image_url
                            ? item.image_url.startsWith("http")
                              ? item.image_url
                              : `${API_BASE_URL}admin/${item.image_url}`
              ...
              <div className="space-y-4 text-sm font-medium text-gray-600 mb-6 border-b border-gray-100 pb-6 border-t pt-6">
                ...
                <div className="flex justify-between">
                  <span>Shipping</span>
                  <span className="font-bold text-green-500 uppercase text-xs tracking-widest">
                    Free
                  </span>
                </div>
              ...
              <div className="flex justify-between items-end mb-8">
                <span className="text-gray-800 font-black uppercase tracking-widest text-xs">
                  Total
                </span>
              ...
              <div className="flex gap-3 mb-6">
                <label
                  className={`relative flex-1 py-3 px-2 rounded-xl cursor-pointer transition-all duration-300 flex items-center justify-center gap-2 border-2 ${
                    paymentMethod === "ONLINE"
                      ? "border-black bg-stone-50 shadow-sm"
                      : "border-gray-100 bg-white hover:border-gray-200 hover:bg-gray-50 opacity-70"
                  }`}
                >
                  <input
                    type="radio"
                  ...
                  <svg
                    ...
                    fill="none"
                    viewBox="0 0 24 24"
                    strokeWidth={paymentMethod === "ONLINE" ? "2.5" : "1.5"}
                    stroke="currentColor"
                    className={`w-4 h-4 ${paymentMethod === "ONLINE" ? "text-black" : "text-gray-400"}`}
                  >
                    <path
                      strokeLinecap="round"
                      strokeLinejoin="round"
                  ...
                  <span
                    className={`text-[9px] font-black uppercase tracking-widest ${paymentMethod === "ONLINE" ? "text-black" : "text-gray-400"}`}
                  >
                    Pay Online
                  </span>
                </label>
                ...
                >
                  ...
                  <svg
                    ...
                    fill="none"
                    viewBox="0 0 24 24"
                    strokeWidth={paymentMethod === "COD" ? "2.5" : "1.5"}
                    stroke="currentColor"
                    className={`w-4 h-4 ${paymentMethod === "COD" ? "text-black" : "text-gray-400"}`}
                  >
                    <path
                      strokeLinecap="round"
                      strokeLinejoin="round"
                  ...
                  <span
                    className={`text-[9px] font-black uppercase tracking-widest ${paymentMethod === "COD" ? "text-black" : "text-gray-400"}`}
                  >
                    COD
                  </span>
                </label>
              ...
              >
                {loading
                  ? "Processing..."
                  : `Place Order (${paymentMethod === "ONLINE" ? "Razorpay" : "COD"})`}
              </button>
              ...
              <div className="mt-8 pt-6 border-t border-gray-100 text-center space-y-4">
                ...
                <div className="grid grid-cols-4 gap-2 items-center justify-center opacity-65 grayscale hover:opacity-100 hover:grayscale-0 transition-all duration-300">
                  <div className="bg-stone-50 border border-stone-100 rounded-xl p-2 flex flex-col items-center justify-center h-11">
                    <span className="text-[10px] font-black tracking-tighter text-stone-700 leading-none">
                      UPI
                    </span>
                    <span className="text-[7px] font-bold text-stone-400 mt-1 uppercase tracking-widest leading-none">
                      GPay / PhonePe
                    </span>
                  </div>
                  <div className="bg-stone-50 border border-stone-100 rounded-xl p-2 flex flex-col items-center justify-center h-11">
                  ...
                  <div className="bg-stone-50 border border-stone-100 rounded-xl p-2 flex flex-col items-center justify-center h-11">
                    <span className="text-[10px] font-black uppercase tracking-tight text-emerald-600 leading-none">
                      COD
                    </span>
                    <span className="text-[7px] font-bold text-stone-400 mt-1 uppercase tracking-widest leading-none">
                      Cash / Pay
                  ...
                  <div className="bg-stone-50 border border-stone-100 rounded-xl p-2 flex flex-col items-center justify-center h-11">
                    <span className="text-[9px] font-extrabold uppercase tracking-widest text-stone-700 leading-none">
                      BANK
                    </span>
                    <span className="text-[7px] font-bold text-stone-400 mt-1 uppercase tracking-widest leading-none">
                      Netbanking
